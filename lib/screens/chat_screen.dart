              ...
              onPressed: () {
                ...
                if(newMessage.isEmpty || newMessage.trim().isEmpty)return;
                  ...
                  _firestore.collection(
                      'messages').add({'sender' : loggedInUser.email,
                      'text' : newMessage, 'time' : formattedDate,
                  });
            },
        ...
        children: [
          ...
          Material(
            borderRadius: BorderRadius.only(
                topLeft: isMe ? const Radius.circular(30) : const Radius
                    .circular(0),
                topRight: isMe ? const Radius.circular(0) : const Radius
                    .circular(30),
